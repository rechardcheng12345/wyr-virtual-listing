...
export default function EditProductModal({ listing, onClose, onUpdated }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { data } = await axios.put<Listing>(`/api/listings/${listing.id}`, fd, {
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            >
              ...
              {listing.file_path ? (
                <p>Current file attached — click/drag to replace</p>
              ) : (
